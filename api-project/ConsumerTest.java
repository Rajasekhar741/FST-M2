...
//Generate a contract
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder){
        ...
        DslPart requestResponseBody = new PactDslJsonBody()
                .numberType("id",199)
                .stringType("firstName","Rajasekhar")
                .stringType("lastName","Reddy")
                .stringType("email","rajasekhar.reddy.vaka1@ibm.com");
    ...
    public  void consumerTest(){
        ...
        reqBody.put("id",199);
        reqBody.put("firstName","Rajasekhar");
        reqBody.put("lastName","Reddy");
        reqBody.put("email","rajasekhar.reddy.vaka1@ibm.com");
